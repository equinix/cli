## equinix smarthandsv1 smarthands handle-smart-hand-locate-package-order
...
```
equinix smarthandsv1 smarthands handle-smart-hand-locate-package-order [flags]
```
...
```
      ...
      --body-service-details-package-description string     Package Description
      --body-service-details-possible-location string       Possible Location
      ...
      --body-service-details-shipment-order-number string   Inbound Shipment Order Number
      --body-service-details-tracking-number string         Tracking Number
  -h, --help                                                help for handle-smart-hand-locate-package-order
