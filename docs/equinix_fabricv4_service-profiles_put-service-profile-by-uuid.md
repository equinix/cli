...
```
  -h, --help                                                                    help for put-service-profile-by-uuid
      ...
      --service-profile-request-environments string                             Provider environments associated with this IC_PROFILE service profile. <font color=\"red\"> <sup color='red'>Beta</sup></font> (JSON array)
      ...
      --service-profile-request-last-mile-config-api-integration string         service-profile-request-last-mile-config-api-integration (JSON)
      --service-profile-request-last-mile-config-product-catalogs string        Last-mile provider catalogs. (JSON array)
