## equinix fabricv4 application-domains delete-app-domain-by-uuid
...
```
equinix fabricv4 application-domains delete-app-domain-by-uuid [flags]
```
...
```
  ...
  -h, --help                   help for delete-app-domain-by-uuid
