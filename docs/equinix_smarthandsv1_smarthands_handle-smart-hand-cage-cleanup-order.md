## equinix smarthandsv1 smarthands handle-smart-hand-cage-cleanup-order
...
```
equinix smarthandsv1 smarthands handle-smart-hand-cage-cleanup-order [flags]
```
...
```
      ...
      --body-service-details-damp-moist-mop-required        Is Damp Moist Mop Requested?
      --body-service-details-permission-to-discard-boxes    Permission To Discard Boxes?
  ...
  -h, --help                                                help for handle-smart-hand-cage-cleanup-order
