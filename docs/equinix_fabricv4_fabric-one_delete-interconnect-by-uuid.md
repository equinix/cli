## equinix fabricv4 fabric-one delete-interconnect-by-uuid
...
```
equinix fabricv4 fabric-one delete-interconnect-by-uuid [flags]
```

### Options

```
  -h, --help                     help for delete-interconnect-by-uuid
      --interconnect-id string   Interconnect UUID (required)
