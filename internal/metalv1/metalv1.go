...
// NewClient creates a new metalv1 API client using the standard
// authentication configuration from internal/api
func NewClient() (*metalv1.APIClient, error) {
	...
	return metalv1.NewAPIClient(configuration), nil
}

// NewClientForDiscovery creates a metalv1 API client for command discovery
// This is used at CLI initialization time to register commands without requiring credentials
func NewClientForDiscovery() (*metalv1.APIClient, error) {
