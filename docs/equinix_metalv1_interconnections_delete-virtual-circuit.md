## equinix metalv1 interconnections delete-virtual-circuit
...
```
equinix metalv1 interconnections delete-virtual-circuit [flags]
```
...
```
  ...
  -h, --help             help for delete-virtual-circuit
