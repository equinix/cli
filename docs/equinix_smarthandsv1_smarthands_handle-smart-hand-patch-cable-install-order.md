## equinix smarthandsv1 smarthands handle-smart-hand-patch-cable-install-order
...
```
equinix smarthandsv1 smarthands handle-smart-hand-patch-cable-install-order [flags]
```
...
```
  ...
  -h, --help                                                help for handle-smart-hand-patch-cable-install-order
