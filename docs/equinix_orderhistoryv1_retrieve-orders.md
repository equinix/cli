## equinix orderhistoryv1 retrieve-orders

Manage retrieve-orders resources

### Synopsis

Commands for managing retrieve-orders resources in the API

### Options

```
  -h, --help   help for retrieve-orders
```
