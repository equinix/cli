## equinix fabricv4 application-services delete-app-service-by-uuid
...
```
equinix fabricv4 application-services delete-app-service-by-uuid [flags]
```
...
```
  ...
  -h, --help                    help for delete-app-service-by-uuid
