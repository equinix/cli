## equinix metalv1 metal-gateways find-metal-gateway-by-id
...
```
equinix metalv1 metal-gateways find-metal-gateway-by-id [flags]
```
...
```
  ...
  -h, --help             help for find-metal-gateway-by-id
