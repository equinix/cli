## equinix fabricv4 application-services get-attached-app-subscriptions-by-app-service-id
...
```
equinix fabricv4 application-services get-attached-app-subscriptions-by-app-service-id [flags]
```
...
```
  ...
  -h, --help                    help for get-attached-app-subscriptions-by-app-service-id
