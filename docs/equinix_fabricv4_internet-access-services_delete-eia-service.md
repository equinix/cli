## equinix fabricv4 internet-access-services delete-eia-service
...
```
equinix fabricv4 internet-access-services delete-eia-service [flags]
```

### Options

```
  -h, --help             help for delete-eia-service
