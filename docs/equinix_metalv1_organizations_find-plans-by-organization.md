## equinix metalv1 organizations find-plans-by-organization
...
```
equinix metalv1 organizations find-plans-by-organization [flags]
```
...
```
  ...
  -h, --help             help for find-plans-by-organization
