...
```
  -h, --help                                                                    help for put-service-profile-by-uuid
      ...
      --service-profile-request-environments string                             service-profile-request-environments (JSON array)
      --service-profile-request-href string                                     Service Profile URI response attribute
      --service-profile-request-last-mile-config-additional-properties string   service-profile-request-last-mile-config-additional-properties (JSON)
      --service-profile-request-last-mile-config-address string                 service-profile-request-last-mile-config-address (JSON)
      --service-profile-request-last-mile-config-notifications string           service-profile-request-last-mile-config-notifications (JSON array)
      --service-profile-request-last-mile-config-product-catalogs string        service-profile-request-last-mile-config-product-catalogs (JSON array)
