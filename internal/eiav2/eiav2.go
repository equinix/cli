...
// NewClient creates a new eiav2 API client using the standard
// authentication configuration from internal/api
func NewClient() (*eiav2.APIClient, error) {
	...
	return eiav2.NewAPIClient(configuration), nil
}

// NewClientForDiscovery creates a eiav2 API client for command discovery
// This is used at CLI initialization time to register commands without requiring credentials
func NewClientForDiscovery() (*eiav2.APIClient, error) {
