## equinix fabricv4 company-profiles detach-private-service-from-profile
...
```
equinix fabricv4 company-profiles detach-private-service-from-profile [flags]
```
...
```
  ...
  -h, --help                        help for detach-private-service-from-profile
