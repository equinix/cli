## equinix smarthandsv1 smarthands handle-smart-hand-others-order
...
```
equinix smarthandsv1 smarthands handle-smart-hand-others-order [flags]
```
...
```
  ...
  -h, --help                                                help for handle-smart-hand-others-order
