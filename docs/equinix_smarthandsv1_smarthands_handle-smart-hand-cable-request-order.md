## equinix smarthandsv1 smarthands handle-smart-hand-cable-request-order
...
```
equinix smarthandsv1 smarthands handle-smart-hand-cable-request-order [flags]
```
...
```
      ...
      --body-service-details-connector-type string          body-service-details-connector-type
      --body-service-details-length string                  Length (feet/cm).
  ...
  -h, --help                                                help for handle-smart-hand-cable-request-order
