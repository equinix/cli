## equinix smarthandsv1 smarthands handle-smart-hand-move-jumper-cable-order
...
```
equinix smarthandsv1 smarthands handle-smart-hand-move-jumper-cable-order [flags]
```
...
```
      ...
      --body-service-details-cable-id string                 Enter Cable ID or ‘None’ if not applicable. This field is mandatory if 'Quantity' is 1.
      --body-service-details-current-device-details string   body-service-details-current-device-details (JSON)
      --body-service-details-new-device-details string       body-service-details-new-device-details (JSON)
  ...
  -h, --help                                                 help for handle-smart-hand-move-jumper-cable-order
